...
TakeScreenshot = KeyboardButton(text='Сделать скриншот')
...
rKeyboardSystem = ReplyKeyboardMarkup(keyboard=[[TurnOff, Reboot], [TakePhoto, TakeScreenshot], [Exit]], resize_keyboard=True)
